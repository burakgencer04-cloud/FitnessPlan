...
import { useAppStore } from '@/app/store'; // Kendi klasör yapına göre ../ sayısını ayarla
// Sonrasında bileşen içinde: const activeThemeId = useAppStore(state => state.activeThemeId);
